...
<div class="page">
	<div class="header">
		<div class="container">
			<p class="title">Privacy Policy for Loveny</p>
		</div>
	</div>
		...
		<div class="container">
			<div class="tab-content translations-content-item en visible" id="en">
				...
				<ul>
					...
					<li>
						<p><strong>Application</strong> refers to Loveny, the software program provided by the Company.</p>
					</li>
					<li>
						<p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Loveny.</p>
					</li>
					<li>
				...
				<ul>
					<li>
						<p>By email: <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="fa969b898e979f97958883c8ccc3ba9d979b9396d4999597">[email&#160;protected]</a>
						</p>
					</li>
					<li>
						<p>By visiting this page on our website: <a href="https://loveny.vn" rel="external nofollow noopener" target="_blank">https://loveny.vn</a>
						</p>
					</li>
				</ul>
			</div>
